...
- Writing documentation without reading the code it describes
- Documenting aspirational features that don't exist yet
- Copy-pasting code examples without verifying they work
- Skipping the Gap Analysis step and writing docs from scratch when updates suffice
- Using jargon without defining it for the target audience
- Leaving placeholder text ("TODO", "TBD") in delivered docs
- Not updating docs when the code changes
- Creating docs outside the `docs/` directory
- Writing walls of prose instead of actionable examples and tables
