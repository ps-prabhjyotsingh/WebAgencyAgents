...
- Reporting on code without actually reading it (relying on filenames or comments alone)
- Skipping the Security Assessment or Performance Assessment sections
- Making assumptions about architecture without tracing data/control flow
- Ignoring test coverage gaps in the Quality Metrics section
- Listing dependencies without checking for known vulnerabilities
- Providing a Health Score without evidence to justify it
- Omitting the "Open Questions / Unknowns" section — there are always unknowns
- Not recommending specific sub-agents for follow-up actions
- Rushing the deep-dive phase to produce a superficial report
