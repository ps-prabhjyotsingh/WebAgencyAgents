...
- Using legacy Tailwind v3 patterns when v4 is available
- Adding `@apply` excessively instead of composing utilities in HTML
- Ignoring accessibility (no focus-visible, no ARIA, no semantic HTML)
- Not checking Lighthouse a11y score before delivering
- Overriding Tailwind defaults without justification
- Using arbitrary values (`bg-[#123456]`) instead of design tokens
- Skipping dark mode / color scheme support when the project uses it
- Not verifying responsive behaviour across breakpoints
- Delivering components without a preview or test
